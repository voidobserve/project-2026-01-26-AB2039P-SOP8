...
#define BSP_UART_TRANSFER_EN            1                       //串口传输使能
...
#define OS_THREAD_DRIVER_EN             0                                   //driver线程使能(有USB功能需使能)
...
#define CLIENT                                      // 从机：屏蔽这个宏；主机：开放这个宏
#ifdef CLIENT
#undef LE_DISCONN_RESTART_ADV_EN
#undef LE_PHY_UPDATE_EN
#undef LE_FEATURE_EXCHANGE_EN
