...
#if FUNC_TBOX_EN
///////////////////////////////////////////////////////////////////////////
#define NOTIFY_POOL_SIZE       ((132/2) + 3)  //2条缓存
...
static uint32_t tbox_notify_tx_pool[NOTIFY_POOL_SIZE] AT(.tbox.att);
...
{
    txpkt_init(tbox_notify_tx_pool, sizeof(tbox_notify_tx_pool));
}
