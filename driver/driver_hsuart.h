...
/**
 * @brief hardware flow ctrl mode
 */
typedef enum {
    HSUT_HFC_NONE           = 0x00,
    HSUT_HFC_CTS            = 0x01,
    HSUT_HFC_RTS            = 0x02,
    HSUT_HFC_CTS_RTS        = 0x03,
    HSUT_HFC_RTS_MANUAL     = 0x0a,
    HSUT_HFC_CTS_RTS_MANUAL = 0x0b,
} HSUT_HFC_TYEPDEF;
...
typedef struct {
    ...
    HSUT_HFC_TYEPDEF            hardware_flow_ctrl_mode;
} hsuart_init_typedef;
