...
void keyscan_init(keyscan_init_typedef *keyscan_init_struct)
{
    ...
    KEYSCAN->con1 &= ~(KEYSCAN_CON1_KEYDIV | KEYSCAN_CON1_KEYPORT_STAB_TIME | KEYSCAN_CON1_KEY_DEBO_TIMES | KEYSCAN_CON1_KEY_WAIT_TIMES);
    KEYSCAN->con1 |= (keyscan_init_struct->clk_div * KEYSCAN_CON1_KEYDIV_0) & KEYSCAN_CON1_KEYDIV;
