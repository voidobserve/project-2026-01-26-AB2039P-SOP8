...
#define CLK_GATE1_TMR4                  ((uint32_t)(0x00000200))        /* CLKGAT1[9] */
#define CLK_GATE1_TMR5                  ((uint32_t)(0x00000400))        /* CLKGAT1[10] */
...
#define CLK_GATE1_X26M                  ((uint32_t)(0x20000000))        /* CLKGAT1[29] */
...
#define CLK_GATE2_TMRP                  ((uint32_t)(0x00000008))        /* CLKGAT2[3] */
#define CLK_GATE2_DCODET                ((uint32_t)(0x00000010))        /* CLKGAT2[4] */
#define CLK_GATE2_SYSX26M               ((uint32_t)(0x00000100))        /* CLKGAT2[8] */
#define CLK_GATE2_X52M                  ((uint32_t)(0x00000200))        /* CLKGAT2[9] */
...
typedef enum {
    ...
    CLK_CLKOUT_TKA_OUT,
    CLK_CLKOUT_BTLP_CLK,
    CLK_CLKOUT_BT_SX_TSCK,
    CLK_CLKOUT_X24M_DIV_CLK,
} CLK_CLKOUT_TYPEDEF;
...
typedef enum {
    ...
    CLK_HSUT0_CLK_UART0_PCLKPP_CLK,
    CLK_HSUT0_CLK_1BIT_CLK,
    CLK_HSUT0_CLK_PLLDIV2_CLK,
    CLK_HSUT0_CLK_PLLDIV3_CLK,
    CLK_HSUT0_CLK_PLLDIV4_CLK,
    CLK_HSUT0_CLK_PLLDIV8_CLK,
...
/**
 * @brief Clock of TMR_CLK Enumeration.
 */
typedef enum {
    CLK_TMR_CLK_1BIT               = 0,
    CLK_TMR_CLK_SYS_CLK,
    CLK_TMR_CLK_XOSC24M_CLK,
    CLK_TMR_CLK_TMR_INR0_CR,
    CLK_TMR_CLK_X24M_CLKDIV24,
    CLK_TMR_CLK_RTC_RC2M,
    CLK_TMR_CLK_TMR_INC1_CR,
    CLK_TMR_CLK_CLKOUT_PIN,
} CLK_TMR_CLK_TYPEDEF;
 ...
 */
typedef enum {
    CLK_UART_CLK_RC24M_CLK         = 0,
    CLK_UART_CLK_TMR_INC0_CR,
    CLK_UART_CLK_X24M_DIV_CLK,
    CLK_UART_CLK_X48M,
} CLK_UART_CLK_TPYEDEF;
...
uint32_t clk_tmr_clk_get(CLK_VALUE_MODE_TYPEDEF mode);
